 ...
 * generated in the org.opentravel.ota._2003._05.ota2010b package. 
...
public class ObjectFactory {
    ...
    private final static QName _TPAExtensions_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "TPA_Extensions");
    private final static QName _Errors_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "Errors");
    private final static QName _Warnings_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "Warnings");
    private final static QName _Success_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "Success");
    private final static QName _ParagraphTypeImage_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "Image");
    private final static QName _ParagraphTypeURL_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "URL");
    private final static QName _ParagraphTypeListItem_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "ListItem");
    private final static QName _ParagraphTypeText_QNAME = new QName("http://www.opentravel.org/OTA/2003/05/OTA2010B", "Text");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.opentravel.ota._2003._05.ota2010b
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "TPA_Extensions")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "Errors")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "Warnings")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "Success")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "Image", scope = ParagraphType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "URL", scope = ParagraphType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "ListItem", scope = ParagraphType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opentravel.org/OTA/2003/05/OTA2010B", name = "Text", scope = ParagraphType.class)
